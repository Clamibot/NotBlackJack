...
public class BreakableWindow : MonoBehaviour {
    ...
    {
        if (other.gameObject.name == "Bullet(Clone)" || other.gameObject.name == "Explosive Plasma Bolt(Clone)" || other.gameObject.name == "Explosion(Clone)" || other.gameObject.name == "Melee")
        {
            breakWindow();
        }
    }
